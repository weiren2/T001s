...
package com.thanksToGithub.expr;
...
public class SyntaxException extends Exception {
	...
	if (scanner.isEmpty()) {
	    ...
	    quotify(sb, theToken());
	    if (isLegalToken()) 
		sb.append(", \nwhich can never be the start of a formula.\n");
	    else
		sb.append(", \nwhich is a meaningless symbol to me.\n");
	} else {
	...
	case INCOMPLETE: 
	    if (isLegalToken())
		sb.append("The first part makes sense, \nbut I don't see " +
